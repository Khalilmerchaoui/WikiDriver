...
import com.app.wikidriver.activities.MainActivity;
import com.app.wikidriver.models.Airport;
import com.app.wikidriver.models.App;
import com.app.wikidriver.models.User;
import com.app.wikidriver.services.CloseAppsService;
import com.app.wikidriver.services.MyAccessibilityService;
    ...
    public static void exitAllApps(final Context context, List<App> appList, final String activity, final String appPackage) {
        ...
        for(final App app : appList) {
            ...
            new Handler().postDelayed(new Runnable() {
                ...
                context.startActivity(intent);
                Log.i("launchedapp", intent.getData().toString());
                }
            }, 500);
        ...
        }, Config.getActivatedAppList(context).size() *  3500);
    }
