...
import com.app.wikidriver.fragments.ChatListFragment;
import com.app.wikidriver.fragments.SocialFragment;
...
import com.app.wikidriver.services.ListenerService;
import com.app.wikidriver.services.StartAppsService;
import com.app.wikidriver.utils.Config;
import com.app.wikidriver.R;
import com.app.wikidriver.fragments.AdvertFragment;
import com.app.wikidriver.fragments.CalendarFragment;
import com.app.wikidriver.fragments.SettingsFragment;
import com.app.wikidriver.helpers.BottomNavigationViewHelper;
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean checked) {
                ...
                if(Settings.canDrawOverlays(getApplicationContext()) && Config.isAccessibilitySettingsOn(getApplicationContext())){
                    ...
                    if (checked) {
                        ...
                        Config.exitAllApps(getApplicationContext(), Config.getActivatedAppList(getApplicationContext()), "main", "");
                        finish();
                    }
